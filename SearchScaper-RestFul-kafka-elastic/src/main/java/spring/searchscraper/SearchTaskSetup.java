...
public class SearchTaskSetup {
	...
	private void addSearchTasks() throws Exception {
		// saveSearchTasks("centralized logging", "\"datadog\", \"metrics\",
		// \"logging\"", true);
		// saveSearchTasks("relational databases", "\"postgres\", \"sql\",
		// \"rbdms\", \"mysql\"", true);
		// saveSearchTasks("programming languages", "\"golang\", \"rust\",
		// \"ruby\", \"python\", \"java\", \"clojure\"", true);
